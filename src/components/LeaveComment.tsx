...
const FormSchema = z.object({
   ...
   isSave: z.enum(["true", "false"]).optional(),
});
   ...
   return (
      <Form {...form}>
         <form
            ...
            className="my-4 w-full space-y-2 px-2.5 md:space-y-4 lg:my-7 lg:space-y-8 xl:px-0"
         >
            ...
            <FormField
               ...
               render={({ field }) => {
                  return (
                     <FormItem className="flex flex-row space-x-1.5 space-y-0 lg:space-x-3">
                        <FormControl>
                           <Checkbox {...field} className="my-auto" />
                        </FormControl>
                        <FormLabel className="font-body text-sm font-normal leading-none text-default-tertiary lg:text-base">
